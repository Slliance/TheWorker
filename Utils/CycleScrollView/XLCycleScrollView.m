...
-(void)addPageControlWithCount:(NSInteger)totalCount{
    ...
    rect.size.width = 30.f * totalCount + 30;
...
//    rect.origin.y = 30;
    rect.size.height = 30;
    if (_isRedPoint) {
        _pageControl = [[AFPageControl alloc] initWithFrame:rect withHighlightImage:[UIImage imageNamed:@"icon_dot_pink_selected"] andNormalImage:[UIImage imageNamed:@"icon_dot_pink_not_selected@2x"] andImageSize:CGSizeMake(6, 6)];


    }
    else{
        _pageControl = [[AFPageControl alloc] initWithFrame:rect withHighlightImage:[UIImage imageNamed:@"img_blue_pressed1"] andNormalImage:[UIImage imageNamed:@"img_white_pressed1"] andImageSize:CGSizeMake(6, 6)];

    }
    _pageControl.spaceBetween = 5.f;
