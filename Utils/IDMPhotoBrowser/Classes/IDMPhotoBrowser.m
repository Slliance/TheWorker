...
//                                                                                          action:@selector(actionButtonPressed:)]];
        _actionButton = [[UIBarButtonItem alloc] initWithTitle:@"保存" style:UIBarButtonItemStylePlain target:self action:@selector(loadImageFinished)] ;
    }
    else {
...
//                                                                  action:@selector(actionButtonPressed:)];
        ...
        [_actionButton setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont boldSystemFontOfSize:14],NSFontAttributeName, nil] forState:UIControlStateNormal];
