...
{
    UINavigationController *nav = [HYTabBarBaseViewController instance].selectedViewController;
    BOOL needPlay = YES;
...
- (void)onRecvRevokeMessageNotification:(NIMRevokeMessageNotification *)notification
{
    ...
    HYTabBarBaseViewController *tabVC = [HYTabBarBaseViewController instance];
...
{
    HYTabBarBaseViewController *tab = [HYTabBarBaseViewController instance];
    [tab.view endEditing:YES];
    if (tab.presentedViewController) {
        __weak HYTabBarBaseViewController *wtabVC = tab;
...
{
    [[HYTabBarBaseViewController instance].selectedViewController.view makeToast:content duration:2.0 position:CSToastPositionCenter];
}
